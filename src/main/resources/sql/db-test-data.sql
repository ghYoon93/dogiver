...
Insert into GOODS (GOODS_ID,CATEGORY_CODE,GOODS_NAME,GOODS_PRICE,GOODS_DATE,GOODS_THUMBNAIL,GOODS_AMT,SALES_YN,GOODS_DETAIL,GOODS_CUM_SALES) values (1010001,101,'핸드메이드 강아지 로프 장난감',3000,to_date('20/04/04','RR/MM/DD'),'1010001/thumbnail.jpg',1,'N','1010001/detail.jpg',71);
