...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dogiver.css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/dogiver.js"></script>
