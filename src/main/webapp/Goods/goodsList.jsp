	...
	<div class="goods-frame">
		<div class="goods-boxs">
			<div class="goods-image" >
				...
				<div class="hover_bar">
					<button type="button" class="btn_basket_cart" href="#" ><img src="../image/shopping_bucket.png"></button>
					<button type="button" class="btn_detail_link" ><img src="../image/search.png"></button>
				</div>
			</div>	
		...
		<div id="option-view" class="layer_option" style="display: none"> 
			<div class="layer_option_cont">
				...
				<div class="option_tit_box">
					<dl>
						<dt><img src="../image/no-image-icon.jpg" width="68" alt="상품명" title="상품명" class="middle"></dt>
						<dd>
							<strong>같이 구하기 되는 있는 뿐이다. 되려니와, 인생의 고동을 이것이다. 있으며, 되려니와, 피고 철환하였는가?</strong>
						</dd>
